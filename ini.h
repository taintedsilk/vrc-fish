...
inline ZIni::ZIni(const char* filePath)
{
	...
	std::string::size_type lastLineBreakIndex;  // record the last line break position (for traversal only). When reaching '=', get the key name directly using this index.
